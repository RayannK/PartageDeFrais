...
public class DepenseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATION_TABLE =
            ...
            + "FOREIGN KEY(" + CLE_UTILISATEUR + ") REFERENCES " +
            UtilisateurHelper.NOM_TABLE + "(" + UtilisateurHelper.CLE + ")); ";
     ...
     */
    private DepenseHelper(Context contexte, String nom,
                          SQLiteDatabase.CursorFactory fabrique, int version) {
